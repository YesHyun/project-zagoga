	...
	<center>
		...
		<div class="container">
			<table class="table table-hover">
				<tr>
					<td>이름</td>
					<td><input type="text" name="u_name" required="required" readonly="readonly">
				</tr>
				<tr>
					<td>닉네임</td>
				...
				<tr>
					<td>주민번호</td>
					<td><input type="text" name="u_jumin" required="required" readonly="readonly">
				</tr>
                <tr>
                    <td>이메일 : </td>
                    <td><input type="text" name="u_jumin" required="required" readonly="readonly">
				...
				<tr align="center">
					<td colspan="4">
						...
						<input type="button" value="취소" onclick="location.href='user_mypage'">
					</td>
				</tr>
			</table>
			</div>
